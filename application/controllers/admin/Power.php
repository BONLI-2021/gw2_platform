...
class Power extends MY_Controller {
	...
	public function admin(){
		...
		$vendorlist = $this->power_model->getAllVendor();
		$this->assign('rolelist',$rolelist);
		$this->assign('vendorlist',json_encode($vendorlist));
	...
	public function ajaxAddAdmin(){
		...
		$data['password'] = md5($data['password'].'GW');
	...
	public function verifyPass(){
		...
		$this->load->model('user_model');
		$res = $this->user_model->selectUserPass(md5(trim($pass).'GW'));
		if($res){
