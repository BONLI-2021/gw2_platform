<?php
/* Smarty version 3.1.29, created on 2021-03-08 14:40:44
...
if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  ...
  'version' => '3.1.29',
  'unifunc' => 'content_6045c6ec98ae02_12045298',
  'file_dependency' => 
  array (
...
function content_6045c6ec98ae02_12045298 ($_smarty_tpl) {
$_smarty_tpl->compiled->nocache_hash = '19887749306045c6ec958577_76584103';
?>
<!DOCTYPE html>
<html><head>
...
/login/captcha?'+Math.random();" style="position: relative;left: 220px;bottom: 8px"></img>
        </div>
...
/fonts/three-dots.svg">');
        ...
        post("<?php echo $_smarty_tpl->tpl_vars['module']->value;?>
" + '/login/doLogin',jsonData,function(res){
            
            if(res.retcode===1){
                layer.msg('登录成功',{icon:1,time:1000},function(){
                    $this.html('登 录');
                    if(res.data['admin_type']==1){
                        window.location.href = "<?php echo $_smarty_tpl->tpl_vars['module']->value;?>
" + '/order/';
                    }else{
                        window.location.href = "<?php echo $_smarty_tpl->tpl_vars['module']->value;?>
" + '/order/orderVendor';
